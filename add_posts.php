...
//        $to = "gokulm.20cse@kongu.edu";
//   $subject = "Important message";
//   $message = "This is a message for all users.";
//   $headers = "From: vigneswarang.20it@kongu.edu" . "\r\n";
//   if (mail($to, $subject, $message, $headers)) {
//     echo "Emails sent successfully.";
//   } else {
//     echo "An error occurred while sending the emails.";
//   }
...
<section class="post-editor">
   ...
   <form action="sendemail.php" method="post" enctype="multipart/form-data">
      ...
      <p>Tag<span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Tag" class="box">
      <p>post image</p>
